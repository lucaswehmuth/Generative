/* By Steve's Makerspace
   ...
   Online editor: https://editor.p5js.org/StevesMakerspace/sketches/HI1Algi8w
   ...
   */
   ...
   let maxYchange = 10;
   let layers = 3;
   let rotStripe = 5; //rotation of each stripe; try 10 or 90;
   ...
   function setup() {
     ...
     for (let i = 0; i < layers; i++) {
       ...
       while ((y1 < end) & (y2 < end) & (y3 < end) & (y4 < end) & (y5 < end) & (y6 < end) & (-maxYchange < minYchange)) {
